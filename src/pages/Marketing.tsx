        ...
        <div className="site-width join-handyman-grid">
          ...
          <section className="join-handyman-card">
            {!submitted ? <form onSubmit={submit}>
              ...
              <div className="field-row"><label>Email<input name="email" type="email" required autoComplete="email" /></label><label>Mobile number<input name="phone" required autoComplete="tel" placeholder="07712 345678 or +447712345678" /></label></div>
