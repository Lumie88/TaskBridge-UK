  ...
  return <div className="intake-layout coordinator-intake">
    <section>
      ...
      <form className="panel intake-form stack" onSubmit={plan}>
        ...
        <label>Care note<textarea required minLength={10} rows={9} value={note} onChange={(event) => setNote(event.target.value)} placeholder="Paste the daily care note. Include every home hazard, preferred timing, key-safe or access instructions and whether a carer will be present." /><small className="field-hint">Multiple hazards are separated into individual tasks; key-safe details are kept as access instructions.</small></label>
